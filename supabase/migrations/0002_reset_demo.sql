...
delete from hechos_imponibles where true;
delete from pasos_tramite where true;
delete from tramites where true;
delete from vinculos where true;
delete from documentos where true;
delete from emisores where true;
delete from ciudadanos where true;
